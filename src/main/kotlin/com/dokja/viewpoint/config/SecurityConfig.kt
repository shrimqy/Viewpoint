    ...
    fun securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests {
                it
                    .requestMatchers("/api/signup", ".api/books/search", "/error").permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/user", "/api/user/signup", "/api/user/login").permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/userbook/**").authenticated()
                    .requestMatchers(HttpMethod.PUT, "/api/userbook/**").authenticated()
//                    .hasRole("ADMIN")
                    .anyRequest()
                    .fullyAuthenticated()
            }
